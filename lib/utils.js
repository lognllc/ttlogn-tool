...
var utils = {
	...
	*/
	...
	returns the prompt of a selected project
	*/
	/*getPromptEstimate: function(ptext, parray){
		var restriction = { description: ptext.magenta,
			pattern: INTEGER,
			default: '-1'
		};
...
*/
	...
	*/
	...
	/*
	returns the prompt of a description
	*/
	// cambiar por get prompt text
	getPromptDescription: function(){
		var restriction = { description: 'Description'.magenta,
			required: true
		};
		return utils.getPrompt(restriction);
	},
	...
	/*
	phourTypes: array of hour types
	returns the prompt of a selected hour type
	*/
	getPromptState: function(phourTypes){
		var restriction = { description: 'Number of state'.magenta,
			required: true,
			pattern: INTEGER
		};
		return utils.getNumberPrompt(restriction, phourTypes);
	},
	...
	returns the prompt of a selected project
	*/
	getPromptProject: function(pprojects){
		var restriction = { description: 'Number of the project'.magenta,
			required: true,
			pattern: INTEGER
		};
		return utils.getNumberPrompt(restriction, pprojects);
	},
	...
	returns the prompt of a selected hour type
	*/
	getPromptHourType: function(phourTypes){
		var restriction = { description: 'Number of hour type'.magenta,
			required: true,
			pattern: INTEGER
		};
		return utils.getNumberPrompt(restriction, phourTypes);
	...
	/*
	pstories: array of stories
	returns the prompt of a selected story
	*/
	getPromptStory: function(pstories){
		var restriction = { description: 'Number of the story'.magenta,
			required: true,
			pattern: INTEGER
		};
		return utils.getNumberPrompt(restriction, pstories);
	},

	/*
	pentries: array of entries
	returns the prompt of a selected entry
	*/
	getPromptTimeEntry: function(pentries){
		var restriction = { description: 'Number of the Time Entry'.magenta,
			required: true,
			pattern: INTEGER
		};
		return utils.getNumberPrompt(restriction, pentries);
	}
...
/* parray: array of items
	...
	parray: array of entries
	print the description of the entries
	
	// delete it use, print array
	printEntries: function(parray){
		_.each(parray, function(value, index){
			index++;
