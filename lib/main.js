var path = require('path'),
	...
	controllerTextualSearch = require(path.resolve(__dirname,'../controllers/controller_textual_search.js')),
...
{	// user credentials
	...
	case 'add':
		...
		{	// repository
			...
			case 'task':
				...
				break;
			default:
			colog.log(colog.colorRed('Error: add [repo|entry|story [-a]|task [-a|-r] ]'));
		}
		break;
	// modify a ...
	case 'modify':
		switch(arg[1])
		{
			...
			case 'story':
				...
				break;
			default:
			colog.log(colog.colorRed('Error: modify [entry|story [-a|-r]|task [-a]]'));
		}
		break;
	// delete a ...
	case 'delete':
		switch(arg[1])
		{
			...
			case 'story':
				break;
			default:
			colog.log(colog.colorRed('Error: delete [entry|repo|story [-a|-r]]'));
		}
		break;
	// list of commits
	case 'ls':
	...
	//textual search
	case 'search':
		controllerTextualSearch.textualSearch(arg);
		break;
	// save the commits
	case 'save':
		controllerSaveWork.saveWork(arg[1], arg[2]);
		break;
	case 'story':
		switch(arg[1])
		{
